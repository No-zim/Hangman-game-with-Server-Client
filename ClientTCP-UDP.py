...
def Client(a, b):
    ...
    #   At this point you're done with TCP for now

    print('Received Server-UDP Port number: ', data2)
    h = 'localhost'
    p = 5002  # creating UDP for yourself
    ...
    while True:
        ...
        while True:  # mess != 'end' and mess != 'exit':
            if mess == 'end':
...
b = int(input("Enter TCP Port number(5000) for server process: "))
Client(a, b)
